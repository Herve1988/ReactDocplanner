...
class Presentations extends Component 
{
    ...
    { 
        return(
            ...
            <section className="partie1 section__interne">
                <img className="partie1__logo" src="https://www.docplanner.com/img/sygnet.png" srcset="https://www.docplanner.com/img/sygnet.png 1x, https://www.docplanner.com/img/sygnet@2x.png 2x"/>
                    <h1>
